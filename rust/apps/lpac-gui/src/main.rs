    ...
    fn ui(&mut self, ui: &mut egui::Ui, _: &mut eframe::Frame) {
        ...
        egui::ScrollArea::vertical()
            ...
            .show(ui, |ui| {
                ...
                ui.heading("NIK LPA");
                ui.label("Керування removable eUICC через перевірений lpac/libeuicc backend");
                ui.add_space(6.0);
                ...
                ui.group(|ui| {
                    ...
                    ui.horizontal_wrapped(|ui| {
                        if ui
                            .add_enabled(!busy, egui::Button::new("Прочитати інформацію eUICC"))
                            .clicked()
                        {
                ...
                ui.group(|ui| {
                    ...
                    ui.horizontal_wrapped(|ui| {
                        if ui
                            .add_enabled(!busy, egui::Button::new("Встановити й перевірити"))
                            .clicked()
                        {
